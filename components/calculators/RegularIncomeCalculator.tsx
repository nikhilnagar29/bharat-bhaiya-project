...
export default function RegularIncomeCalculator({ onAdvisor }: CalcProps) {
  const [lumpsum, setLumpsum] = useState(1000000);
  const [swp, setSwp] = useState(10000);
  ...
  return (
    <div className={styles.calc}>
      <div className={styles.header}>
        <h2 className="heading-3" style={{ color: 'var(--navy-800)' }}>Regular Income Calculator</h2>
        <p className="body-sm text-muted">
          Plan your regular income from your Lumpsum investment.
        </p>
      </div>
